...
class JiJDependencyData {
    public static final DependencyAction<String> DEFAULT_PATH = { ResolvedArtifact artifact, ModuleDependency dependency -> artifact.file.name }
    ...
    DependencyAction<String> path = DEFAULT_PATH
    boolean obfuscated
